...
static FingerState fingers[MAX_FINGERS];


// 颜色定义
#define TRAJ_COLOR_RED     0x00FF0000
#define TRAJ_COLOR_GREEN   0x0000FF00
#define TRAJ_COLOR_BLUE    0x000000FF
#define TRAJ_COLOR_ORANGE  0x00FFA500
#define TRAJ_COLOR_PURPLE  0x00FF00FF
#define TRAJ_COLOR_BLACK   0x00000000
#define TRAJ_COLOR_WHITE   0x00FFFFFF

// 清除按钮定义
#define CLEAR_BTN_X        (SCREEN_WIDTH - 100)
#define CLEAR_BTN_Y        20
#define CLEAR_BTN_WIDTH    80
#define CLEAR_BTN_HEIGHT   40
